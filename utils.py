...
from data import ImageFilelist, ImageFolder, ir_loader
import torch
...
def get_data_loader_folder(input_folder, batch_size, train, new_size=None,
    ...
    if 'testA' in input_folder or 'trainA' in input_folder:
        dataset = ImageFolder(input_folder, transform=transform)
    elif 'testB' in input_folder or 'trainB' in input_folder:
